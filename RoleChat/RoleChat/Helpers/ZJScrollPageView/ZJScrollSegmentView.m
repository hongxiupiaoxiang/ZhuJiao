...
//                coverW = 60;
            ...
            self.scrollLine.frame = CGRectMake(SCREEN_WIDTH/(self.titles.count*2.0)-width*0.5 , self.zj_height - self.segmentStyle.scrollLineHeight, width, self.segmentStyle.scrollLineHeight);
...
//                weakSelf.scrollLine.zj_width = 60;
//                weakSelf.scrollLine.zj_x = SCREEN_WIDTH/(self.titles.count*2)-weakSelf.scrollLine.zj_width*0.5+_currentIndex*SCREEN_WIDTH*1.0/self.titles.count;
...
//                    weakSelf.scrollLine.zj_width = currentTitleView.zj_width;
                    ...
                    weakSelf.scrollLine.zj_x = currentTitleView.zj_x+currentTitleView.zj_width*0.5-30;
                    weakSelf.scrollLine.zj_width = 60;
                }
